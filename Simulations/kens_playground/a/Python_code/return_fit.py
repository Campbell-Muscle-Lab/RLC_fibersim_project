...
def return_fit(thread_id_dir):
    ...
    # Open the pCa data
    pCa_data_file = os.path.join(sim_data_folder, pCa_data_file)
    
    pCa_data = pd.read_excel(pCa_data_file,
                             sheet_name = pCa_sheet)
    
    # Open the k_tr file
    k_tr_data_file = os.path.join(sim_data_folder, k_tr_data_file)
    ...
    comparison_file = os.path.join(sim_data_folder, comparison_file)
